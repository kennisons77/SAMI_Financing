  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created target as @target" do
        ...
        expect(assigns(:target)).to be_persisted
      end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved target as @target" do
        post :create, {:target => invalid_attributes}, valid_session
        expect(assigns(:target)).to be_a_new(Target)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested target" do
        target = Target.create! valid_attributes
        put :update, {:id => target.to_param, :target => new_attributes}, valid_session
        target.reload
    ...
    describe "with invalid params" do
      it "assigns the target as @target" do
        target = Target.create! valid_attributes
        put :update, {:id => target.to_param, :target => invalid_attributes}, valid_session
        expect(assigns(:target)).to eq(target)
      end
